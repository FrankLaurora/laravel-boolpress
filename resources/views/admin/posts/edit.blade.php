                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="category" name="category_id">
                            ...
                            @foreach ($categories as $category)
                                <option {{old('category_id') != null && old('category_id') == $category->id || isset($post->category_id) && $post->category_id == $category->id ? 'selected' : null}} value="{{$category->id}}">{{$category->name}}</option>
                            @endforeach
                        </select>
